package TestSpring.springwithmybatis.utils;
...
public class HttpServletUtils {
	 ...
	 * @param object
	 */
	public static void responseAccessData(HttpServletResponse response, Object object) {

		RespObject respObject = new RespObject(RespObject.SUCCESS, RespObject.SUCCESS_MSG, object);
	...
	public static void responseErrorData(HttpServletResponse response, int respCode, String respMsg) {
		...
		RespObject respObject = new RespObject(respCode, respMsg, null);
		Gson gson = new GsonBuilder().create();
		responseJson(response, gson.toJson(respObject));
	}
